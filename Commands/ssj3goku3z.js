module.exports = {
    name: 'ssj3goku3z',
    description: 'AGL UR Super Saiyan 3 Goku with EZA',
    ...
    status: 'complete',
    plural: 'false',
    aliases: ['ss3goku3z', 'Super Saiyan 3 Goku Z'],
    execute(message, args) {
        const {link} = require('./ssj3goku3z.js')
        const {categories} = require('./ssj3goku3z.js')
        const {status} = require('./ssj3goku3z.js')
        const {plural} = require('./ssj3goku3z.js')
        const {aliases} = require('./ssj3goku3z.js')
        var color = 2317729;
        var name = "Mystery Super Technique\nSuper Saiyan 3 Goku Z";
        var url = "https://dbz-dokkanbattle.fandom.com/wiki/Mystery_Super_Technique_Super_Saiyan_3_Goku#Extreme%20Z-Awakened";
        ...
        var leader = "<:agl:729467484289105930> Type Ki +3 and HP, ATK & DEF +70%";
        var superatk = "[Dragon Fist](https://dbz-dokkanbattle.fandom.com/wiki/File:(Super_Attack)_Super_Saiyan_3_Goku_-_Mystery_Super_Technique_(AGL)): Causes immense damage to enemy and greatly lowers DEF[1]";
        var passive = "Battle to the End: DEF +70% at start of turn; ATK +120% for 7 turns from start of turn";
        var stats = "HP: 15,327 (55%)/18,967 (100%)\nATK: 13,911 (55%)/18,111 (100%)\nDEF: 8,596 (55%)/13,356 (100%)";
        var links = "";
