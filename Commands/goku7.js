module.exports = {
    ...
    execute(message, args) {
        const {link} = require('./goku7.js')
        const {categories} = require('./goku7.js')
        const {status} = require('./goku7.js')
        const {plural} = require('./goku7.js')
        const {aliases} = require('./goku7.js')
        var color = 8990259;
        var name = "Pinnacle of Fury\nGoku";
        var url = "https://dbz-dokkanbattle.fandom.com/wiki/Pinnacle_of_Fury_Goku";
        var desc = "Super STR UR";
        var circle = "https://media.discordapp.net/attachments/712036120191434793/729388527472869526/card_1017180_circle.png";
        var character = "https://media.discordapp.net/attachments/712036120191434793/729388614781370418/340.png";
        var leader = "\"[Super Saiyans](https://dbz-dokkanbattle.fandom.com/wiki/Super_Saiyans)\" or \"[Planet Namek Saga](https://dbz-dokkanbattle.fandom.com/wiki/Planet_Namek_Saga)\" Category Ki +3, HP +130% and ATK & DEF +170%";
        var superatk = "[Large Spirit Bomb](https://dbz-dokkanbattle.fandom.com/wiki/File:(Super_Attack_%26_Transformation)_Goku_-_Extreme_Anger): Causes immense damage to enemy and raises allies' ATK by 30% for 1 turn";
        var passive = "Pulsing Strength: ATK & DEF +77%; ATK & DEF +15% with each attack received (up to 59%); Transform when conditions are met";
        var transform = "Transform when HP is 70% or less, starting from the 3rd turn from the start of battle"
        var stats = "HP: 14,350 (55%)/17,350 (100%)\nATK: 13,388 (55%)/16,788 (100%)\nDEF: 8,715 (55%)/11,315 (100%)";
        var links = "";
            ...
            if (!args.length)
            {
                message.channel.send({embed: {
                    ...
                    fields: [
                        ...
                        {
                            name: "Transformation Conditions",
                            value: transform
                        },
                        {
                            name: "Stats",
