module.exports = {
    ...
    execute(message, args) {
        ...
        var url = "https://dbz-dokkanbattle.fandom.com/wiki/Transcendent_Height_Kefla#Super%20Saiyan%202%20Kefla";
        ...
        var passive = "I'm The Strongest!: Ki +2 and DEF +160%; ATK +160% when performing a Super Attack; high chance[3] of evading enemy's attack (including Super Attack); launches an additional Super Attack with 6 or more Ki Spheres obtained";
