module.exports = {
    name: 'ssjgogeta1',
    description: 'AGL UR Super Saiyan Gogeta before transformation',
    ...
    status: 'complete',
    plural: 'false',
    aliases: ['ssgogeta1', 'Super Saiyan Gogeta'],
    execute(message, args) {
        const {link} = require('./ssjgogeta1.js')
        const {categories} = require('./ssjgogeta1.js')
        const {status} = require('./ssjgogeta1.js')
        const {plural} = require('./ssjgogeta1.js')
        const {aliases} = require('./ssjgogeta1.js')
        var color = 2317729;
        var name = "Transcendent Fusion\nSuper Saiyan Gogeta";
        var url = "https://dbz-dokkanbattle.fandom.com/wiki/Transcendent_Fusion_Super_Saiyan_Gogeta";
        var desc = "Super AGL UR";
        var circle = "https://media.discordapp.net/attachments/712036120191434793/718646200097701918/card_1015970_circle.png";
        var character = "https://media.discordapp.net/attachments/712036120191434793/720707713511981249/xfAKONUaOhhpMAAAAASUVORK5CYII.png";
        ...
        var superatk = "[Stardust Fall](https://dbz-dokkanbattle.fandom.com/wiki/File:Dokkan_Battle_Super_Saiyan_Gogeta_Animations): Greatly raises ATK for 1 turn[1] and causes immense damage to enemy";
        var passive = "True Strength: ATK & DEF +100%; attacks effective against all Types; medium chance[2] of evading enemy's attack (including Super Attack); [Transform](https://dbz-dokkanbattle.fandom.com/wiki/File:Dokkan_Battle_Super_Saiyan_Gogeta_Animations) when conditions are met";
        var transform = "Transform starting from the 5th turn from the start of battle";
        ...
        var apt = "APT: 3,987,955  (unsupported)/4,518,353 (supported)\nDefense: 94,616 (unsupported)/107,200 (supported) \nLinking Partner: [STR LR Gogeta](https://dbz-dokkanbattle.fandom.com/wiki/The_Strongest_Ultimate_Fusion_Gogeta) \nTeam: [Movie Heroes](https://dbz-dokkanbattle.fandom.com/wiki/Movie_Heroes) \nBuild: 20 Additional/6 Critical";
        var blp = "[INT UR Super Gogeta](https://dbz-dokkanbattle.fandom.com/wiki/Outshining_Darkness_Super_Gogeta) - 6 links shared\n[STR UR Super Gogeta](https://dbz-dokkanbattle.fandom.com/wiki/The_Supreme_Warrior_Super_Gogeta) - 6 links shared\n[TEQ UR Super Saiyan God Goku](https://dbz-dokkanbattle.fandom.com/wiki/God%27s_Effortless_Controlling_Aura_Super_Saiyan_God_Goku) - 5 links shared";
