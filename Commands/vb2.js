module.exports = {
    ...
    execute(message, args) {
        ...
        var deets = "► 12 Ki Multiplier is 160%\n► If your team has one card of each Super Type ([Super AGL](https://dbz-dokkanbattle.fandom.com/wiki/Category:Super_AGL)/[Super TEQ](https://dbz-dokkanbattle.fandom.com/wiki/Category:Super_TEQ)/[Super INT](https://dbz-dokkanbattle.fandom.com/wiki/Category:Super_INT)/[Super STR](https://dbz-dokkanbattle.fandom.com/wiki/Category:Super_STR)/[Super PHY](https://dbz-dokkanbattle.fandom.com/wiki/Category:Super_PHY)) those allies will receive the boost, meaning that they need to be at least Z-Awakened";
