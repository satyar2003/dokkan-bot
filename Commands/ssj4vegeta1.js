module.exports = {
    ...
    execute(message, args) {
        ...
        var leader = "\"[Vegeta's Family](https://dbz-dokkanbattle.fandom.com/wiki/Vegeta%27s_Family)\" Category Ki +3, HP +130% and ATK & DEF +170%; or Super STR Type Ki +3 and HP, ATK & DEF +120%";
        ...
        var passive = "This Isn't the End!: DEF +80%; ATK +20% at start of each turn (up to 80%); plus an additional Ki +2 per <:rbw:729467948690964480> or STR Ki Sphere obtained; medium chance[3] of evading enemy's Super Attack and countering with tremendous power";
