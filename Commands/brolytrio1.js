...
module.exports = {
    ...
    execute(message, args) {
        ...
        var leader = "\"[Movie Bosses](https://dbz-dokkanbattle.fandom.com/wiki/Movie_Bosses)\" Category Ki +4 and HP, ATK & DEF +130%; or [Extreme PHY](https://dbz-dokkanbattle.fandom.com/wiki/Category:Extreme_PHY) Type Ki +4 and HP, ATK & DEF +100%";
        ...
        var passive = "ATK & DEF +15% per Ki Sphere obtained; plus an additional ATK & DEF +5% and Ki +2 per Ki Sphere with 2 or more [PHY](https://dbz-dokkanbattle.fandom.com/wiki/Category:PHY) Ki Spheres obtained; all allies' ATK +39% with 2 or more [AGL](https://dbz-dokkanbattle.fandom.com/wiki/Category:AGL) or [STR](https://dbz-dokkanbattle.fandom.com/wiki/Category:STR) Ki Spheres obtained; all allies' DEF +39% with 2 or more [TEQ](https://dbz-dokkanbattle.fandom.com/wiki/Category:TEQ) or [INT](https://dbz-dokkanbattle.fandom.com/wiki/Category:INT) Ki Spheres obtained; evades enemy's attack (including Super Attack) with 7 or more Ki Spheres obtained";
