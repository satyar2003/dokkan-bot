module.exports = {
    name: 'sgogeta1z',
    description: 'STR UR Super Gogeta with EZA',
    ...
    status: 'complete',
    plural: 'false',
    aliases: ['Super Gogeta Z'],
    execute(message, args) {
        const {link} = require('./sgogeta1z.js')
        const {categories} = require('./sgogeta1z.js')
        const {status} = require('./sgogeta1z.js')
        const {plural} = require('./sgogeta1z.js')
        const {aliases} = require('./sgogeta1z.js')
        var color = 8990259;
        var name = "The Supreme Warrior\nSuper Gogeta Z";
        var url = "https://dbz-dokkanbattle.fandom.com/wiki/The_Supreme_Warrior_Super_Gogeta#Extreme%20Z-Awakened";
        ...
        var leader = "All Types Ki +3 and HP, ATK & DEF +77%";
        var superatk = "[Soul Punisher](https://dbz-dokkanbattle.fandom.com/wiki/File:(Super_Attack)_Super_Gogeta_-_The_Supreme_Warrior_(STR)): Causes immense damage to enemy and lowers ATK & DEF[1]";
        var passive = "Overwhelming Strike: ATK & DEF +77%; ATK +7% per <:rbw:729467948690964480> Ki Sphere obtained; attacks effective against all Types";
