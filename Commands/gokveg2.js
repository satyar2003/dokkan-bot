module.exports = {
    name: 'gokveg2',
    description: 'INT LR Super Saiyan Goku & Super Saiyan Vegeta',
    ...
    status: 'complete',
    plural: 'true',
    aliases: ['Super Saiyan Goku & Super Saiyan Vegeta'],
    execute(message, args) {
        const {link} = require('./gokveg2.js')
        const {categories} = require('./gokveg2.js')
        const {status} = require('./gokveg2.js')
        const {plural} = require('./gokveg2.js')
        const {aliases} = require('./gokveg2.js')
        var color = 7028604;
        var name = "Fused Super Power\nSuper Saiyan Goku & Super Saiyan Vegeta";
        var url = "https://dbz-dokkanbattle.fandom.com/wiki/Fused_Super_Power_Super_Saiyan_Goku_%26_Super_Saiyan_Vegeta";
        var desc = "Super INT LR";
        var circle = "https://media.discordapp.net/attachments/712036120191434793/723037414515408896/card_1012900_circle.png";
        var character = "https://media.discordapp.net/attachments/712036120191434793/723037632170557451/ckSzP1uHWMoEHpAZAAAAAElFTkSuQmCC.png";
        var leader = "\"[Potara](https://dbz-dokkanbattle.fandom.com/wiki/Potara)\" Category Ki +3, HP & ATK +170% and DEF +130%; or <:int:729468835819946026> Type Ki +3, HP & ATK +170% and DEF +130%;";
        var superatk = "[Kamehameha & Big Bang Attack](https://dbz-dokkanbattle.fandom.com/wiki/File:DBZ_Dokkan_Battle_Super_Powered_Fusion_-_Super_Saiyan_Goku_%26_Vegeta_(Super_Attack)) (12-17 Ki): Causes colossal damage to enemy\n[Final Strategy](https://dbz-dokkanbattle.fandom.com/wiki/File:DBZ_Dokkan_Battle_Super_Powered_Fusion_-_Super_Saiyan_Goku_%26_Vegeta_(Ultra_Super_Attack)) (18+ Ki): Raises ATK for 1 turn[1] and causes mega-colossal damage to enemy";
        var passive = "Strongest Duo: ATK and DEF +120% at start of turn; Ki +2 in addition per <:rbw:729467948690964480> Ki Sphere obtained; perform Potara fusion when conditions are met";
        var transform = "Perform Potara fusion when HP is 50% or below, starting from the 6th turn from the start of battle"
            ...
            if (!args.length)
            {
                message.channel.send({embed: {
                    ...
                    fields: [
                        ...
                        {
                            name: "Potara Fusions Conditions",
                            value: transform
                        },
                        {
                            name: "Stats",
