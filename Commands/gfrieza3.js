module.exports = {
    name: 'gfrieza3',
    description: 'INT UR Golden Frieza without EZA',
    ...
    execute(message, args) {
        const {link} = require('./gfrieza3.js')
        const {categories} = require('./gfrieza3.js')
        const {status} = require('./gfrieza3.js')
        const {plural} = require('./gfrieza3.js')
        const {aliases} = require('./gfrieza3.js')
        var color = 7028604;
        var name = "Golden Malice\nGolden Frieza";
        var url = "https://dbz-dokkanbattle.fandom.com/wiki/Golden_Malice_Golden_Frieza";
        ...
        var leader = "<:teq:729467504593862728>, <:int:729468835819946026> & <:str:729468929293942894> Type HP & ATK +30%";
        var superatk = "Earth Breaker: Causes supreme damage to enemy";
        var passive = "Golden Evolution: ATK & DEF +60% at start of turn";
        var stats = "HP: 11,035 (55%)/14,035 (100%)\nATK: 10,132 (55%)/13,132 (100%)\nDEF: 6,815 (55%)/9,815 (100%)";
        var links = "";
