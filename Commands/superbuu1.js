...
module.exports = {
    ...
    execute(message, args) {
        ...
        var leader = "[Extreme PHY](https://dbz-dokkanbattle.fandom.com/wiki/Category:Extreme_PHY) Type Ki +4 and HP, ATK & DEF +120%";
        var superatk = "[Vice Shout](https://youtu.be/MphVEwatII0): Causes supreme damage to enemy and recovers 18% HP";
        var passive = "Evil Shout: [PHY](https://dbz-dokkanbattle.fandom.com/wiki/Category:PHY) Type Ki +3 plus an additional ATK & DEF +50% for [Extreme PHY](https://dbz-dokkanbattle.fandom.com/wiki/Category:Extreme_PHY) Type; randomly changes Ki Spheres of a certain Type ([PHY](https://dbz-dokkanbattle.fandom.com/wiki/Category:PHY) excluded) to [PHY](https://dbz-dokkanbattle.fandom.com/wiki/Category:PHY) Ki Spheres; ATK & DEF +20% per Ki Sphere obtained";
