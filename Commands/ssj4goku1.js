module.exports = {
    ...
    execute(message, args) {
        ...
        var leader = `"[Goku's Family](https://dbz-dokkanbattle.fandom.com/wiki/Goku%27s_Family)" Category Ki +3, HP & ATK +170% and DEF +130%; or Super AGL Type Ki +3 and HP, ATK & DEF +120%`;
        ...
        var passive = "Victory Will Be Mine!: ATK +80%; DEF +20% at start of each turn (up to 80%); plus an additional Ki +2 per <:rbw:729467948690964480> or AGL Ki Sphere obtained; medium chance[3] of evading enemy's Super Attack and countering with tremendous power";
