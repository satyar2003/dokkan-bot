module.exports = {
    ...
    link: ['[Cold Judgment](https://dbz-dokkanbattle.fandom.com/wiki/Cold_Judgment)\n ­ ­ ­ ­ Level 1: DEF +20%\n ­ ­ ­ ­ Level 10: DEF +25%',
    ...
    execute(message, args) {
        ...
        var leader = `"[Time Travelers](https://dbz-dokkanbattle.fandom.com/wiki/Time_Travelers)" Category Ki +3 and HP, ATK & DEF +150%; or Extreme INT Type Ki +3 and HP, ATK & DEF +90%`;
