module.exports = {
    ...
    execute(message, args) {
        ...
        var passive = "Our Will to Survive: ATK +30% and DEF +10% per Ki Sphere obtained; attacks effective against all Types; randomly changes Ki Spheres of a certain Type (TEQ excluded) to TEQ Ki Spheres (once only)";
