module.exports = {
    name: 'uigoku2',
    description: 'INT UR Goku (Ultra Instinct -Sign-)',
    ...
    execute(message, args) {
        const {link} = require('./uigoku2.js')
        const {categories} = require('./uigoku2.js')
        const {status} = require('./uigoku2.js')
        ...
        var leader = "\"[Realm of Gods](https://dbz-dokkanbattle.fandom.com/wiki/Realm_of_Gods)\" Category Ki +3 and HP, ATK & DEF +150%; or INT Type Ki +3 and HP, ATK & DEF +50%";
