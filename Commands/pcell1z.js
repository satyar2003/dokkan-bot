module.exports = {
    name: 'pcell1z',
    description: 'TEQ UR Perfect Cell with EZA',
    ...
    link: ['[Revival](https://dbz-dokkanbattle.fandom.com/wiki/Revival) (Ki +2)',
           ...
           '[Attack of the Clones](https://dbz-dokkanbattle.fandom.com/wiki/Attack_of_the_Clones) (Ki +1)',
    ...
    execute(message, args) {
        var color = 3040566;
        var name = "Surpassing All\nPerfect Cell Z";
        var url = "https://dbz-dokkanbattle.fandom.com/wiki/Surpassing_All_Perfect_Cell#Extreme%20Z-Awakened";
        var desc = "Extreme TEQ UR";
        var circle = "https://media.discordapp.net/attachments/712036120191434793/714657122998026310/card_1004650_circle.png";
        var character = "https://media.discordapp.net/attachments/712036120191434793/720702310082150501/340.png";
        var leader = "<:teq:729467504593862728> Type Ki +3 and HP, ATK & DEF +70%";
        var superatk = "Solar Kamehameha: Causes immense damage to enemy and recovers 10% HP";
        var passive = "Avatar of Contempt: ATK & DEF +15% per Ki Sphere obtained; Ki +1 in addition per <:rbw:729467948690964480> Ki Sphere obtained";
        var stats = "HP: 15,389 (55%)/19,029 (100%)\nATK: 13,807 (55%)/18,567 (100%)\nDEF: 10,243 (55%)/14,443 (100%)";
        const {link} = require('./pcell1z.js')
        var links = "";
            for (var i = 0; i < link.length; i++)
            {
                links += link[i] + "\n";
            }
        const {categories} = require('./pcell1z.js')
        var cats = "";
            for (var i = 0; i < categories.length; i++)
            {
                cats += categories[i] + "\n";
            }
        var apt = "APT: 2,929,128 (unsupported)/3,515,617 (supported)\nDefense: 125,509\nLinking Partner: [INT LR Cell (Perfect Form)](https://dbz-dokkanbattle.fandom.com/wiki/The_True_Value_of_Perfect_Form_Cell_(Perfect_Form)) \nTeam: [Androids](https://dbz-dokkanbattle.fandom.com/wiki/Androids) \nBuild: 6 Additional/20 Critical";
        ...
        var footnotes = "";
        const {status} = require('./pcell1z.js')
        if (status === 'incomplete')
        {
            message.channel.send({embed: {
                ...
                title: "Perfect Cell Z is coming soon."
            }});
        }
        else
        {
