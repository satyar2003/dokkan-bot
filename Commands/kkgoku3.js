module.exports = {
    name: 'kkgoku3',
    description: 'AGL UR Goku (Kaioken)',
    ...
    execute(message, args) {
        const {link} = require('./kkgoku3.js')
        const {categories} = require('./kkgoku3.js')
        const {status} = require('./kkgoku3.js')
        const {plural} = require('./kkgoku3.js')
        const {aliases} = require('./kkgoku3.js')
        var color = 2317729;
        var name = "Last-Second Gambit\nGoku (Kaioken)";
        var url = "https://dbz-dokkanbattle.fandom.com/wiki/Last-Second_Gambit_Goku_(Kaioken)";
        var desc = "Super AGL UR";
        var circle = "https://media.discordapp.net/attachments/712036120191434793/729463386215022602/card_1006660_circle.png";
        var character = "https://media.discordapp.net/attachments/712036120191434793/729463431551254538/340.png";
        var leader = "All Types HP & ATK +30%";
        var superatk = "[x20 Kaioken Kamehameha](https://dbz-dokkanbattle.fandom.com/wiki/File:Last_Second_Gambit_Goku_(Kaioken)_Super_ATK): Greatly raises ATK[1] and causes supreme damage to enemy";
        var passive = "Power Level Surge: ATK +7000 and DEF +3000 at start of turn";
        var stats = "HP: 10,286 (55%)/12,886 (100%)\nATK: 10,536 (55%)/13,536 (100%)\nDEF: 6,347 (55%)/9,747 (100%)";
        var links = "";
