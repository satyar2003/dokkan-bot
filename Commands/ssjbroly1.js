module.exports = {
    ...
    execute(message, args) {
        ...
        var leader = `"[Resurrected Warriors](https://dbz-dokkanbattle.fandom.com/wiki/Resurrected_Warriors)" Category Ki +4 and HP, ATK & DEF +130%; or Extreme TEQ Type Ki +4 and HP, ATK & DEF +100%`;
