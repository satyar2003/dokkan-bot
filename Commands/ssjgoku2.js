module.exports = {
    name: 'ssjgoku2',
    description: 'INT UR Super Saiyan Goku from *Battle of Gods*',
    ...
    status: 'complete',
    plural: 'false',
    aliases: ['ssgoku2', 'Super Saiyan Goku'],
    execute(message, args) {
        const {link} = require('./ssjgoku2.js')
        const {categories} = require('./ssjgoku2.js')
        const {status} = require('./ssjgoku2.js')
        const {plural} = require('./ssjgoku2.js')
        const {aliases} = require('./ssjgoku2.js')
        var color = 7028604;
        var name = "Saiyan of a New Dimension\nSuper Saiyan Goku";
        var url = "https://dbz-dokkanbattle.fandom.com/wiki/Saiyan_of_a_New_Dimension_Super_Saiyan_Goku";
