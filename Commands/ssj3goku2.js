module.exports = {
    name: 'ssj3goku2',
    description: 'TEQ LR Super Saiyan 3 Goku',
    ...
    status: 'complete',
    plural: 'false',
    aliases: ['ss3goku2', 'Super Saiyan 3 Goku'],
    execute(message, args) {
        var color = 3040566;
        var name = "Golden Fist\nSuper Saiyan 3 Goku";
        var url = "https://dbz-dokkanbattle.fandom.com/wiki/Golden_Fist_Super_Saiyan_3_Goku";
        var desc = "Super TEQ LR";
        var circle = "https://media.discordapp.net/attachments/712036120191434793/716023434920067152/card_1012720_circle.png";
        var character = "https://media.discordapp.net/attachments/712036120191434793/720705264902340638/wVE4WOuZCaWRQAAAABJRU5ErkJggg.png";
        var leader = "<:steq:729475811966713918> Type Ki +4 and HP, ATK & DEF +100%; <:eteq:729475482105544734> Type Ki +2 and HP, ATK & DEF +70%";
        var superatk = "Instant Transmission Kamehameha (12-17 Ki): Causes colossal damage with a rare chance to stun the enemy[1]\n[Dragon Fist](https://dbz-dokkanbattle.fandom.com/wiki/File:DBZ_Dokkan_Battle_Golden_Fist_-_Super_Saiyan_3_Goku_(Ultra_Super_Attack)) (18+ Ki): Causes mega-colossal damage to enemy and greatly lowers DEF[2]";
        var passive = "Certain Triumph: DEF +120% at start of turn; ATK +180% and DEF -70% when performing an Ultra Super Attack";
        var stats = "HP: 16,775 (55%)/19,375 (100%)\nATK: 19,060 (55%)/22,460 (100%)\nDEF: 10,913 (55%)/13,913 (100%)";
        const {link} = require('./ssj3goku2.js')
        var links = "";
            for (var i = 0; i < link.length; i++)
            {
                links += link[i] + "\n";
            }
        const {categories} = require('./ssj3goku2.js')
        var cats = "";
            for (var i = 0; i < categories.length; i++)
            {
                cats += categories[i] + "\n";
            }
        var apt = "APT: 6,367,426 (unsupported)/7,611,195 (supported)\nDefense: 40,403 \nLinking Partner: [INT UR Super Saiyan 3 Bardock](https://dbz-dokkanbattle.fandom.com/wiki/Mark_of_Saiyan_Strength_Super_Saiyan_3_Bardock) \nTeam: [Super Saiyan 3](https://dbz-dokkanbattle.fandom.com/wiki/Super_Saiyan_3) \nBuild: 6 Additional/20 Critical";
        var blp = "[INT LR Super Saiyan God Goku](https://dbz-dokkanbattle.fandom.com/wiki/Legend_Reborn_Super_Saiyan_God_Goku) - 5 links shared\n[INT UR Super Saiyan 3 Gohan (Teen)](https://dbz-dokkanbattle.fandom.com/wiki/Unmeasurable_Super_Combat_Power_Super_Saiyan_3_Gohan_(Teen)) - 5 links shared\n[STR UR Super Saiyan 3 Goku (Xeno)](https://dbz-dokkanbattle.fandom.com/wiki/Limit-Breaking_Super_Power_Super_Saiyan_3_Goku_(Xeno)) - 5 links shared";
        var deets = "► 12 Ki Multiplier is 150%; 24 Ki Multiplier is 200%\n ­ ­ ­ ­ ­▫ Full [12-24 Ki Multipliers](https://dbz-dokkanbattle.fandom.com/wiki/Ki_Multipliers) table\n► SA Lv.20 raises [SA Multiplier](https://dbz-dokkanbattle.fandom.com/wiki/Super_Attack_Multipliers) by an additional 30%\n► When performing an Ultra Super Attack, SS3 Goku isn't left with a +50% DEF boost, but with 30% of his total DEF, because the second part of his Passive Skill is calculated separately\n► If he performs an Ultra Super Attack, he'll keep his ATK buff for any additional attack in that turn";
        var footnotes = "[1]: 20% chance to stun the enemy for 2 turns\n[2]: Lowers enemy's DEF by 50% for 3 turns";
        const {status} = require('./ssj3goku2.js')
        if (status === 'incomplete')
        {
            /*message.channel.send({embed: {
                ...
                title: "Super Saiyan 3 Goku is coming soon."
            }})*/
        }
        else
        {
