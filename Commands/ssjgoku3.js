module.exports = {
    name: 'ssjgoku3',
    description: 'TEQ LR Prime Battle Super Saiyan Goku',
    ...
    status: 'complete',
    plural: 'false',
    aliases: ['ssgoku3', 'Super Saiyan Goku'],
    execute(message, args) {
        const {link} = require('./ssjgoku3.js')
        const {categories} = require('./ssjgoku3.js')
        const {status} = require('./ssjgoku3.js')
        const {plural} = require('./ssjgoku3.js')
        const {aliases} = require('./ssjgoku3.js')
        var color = 3040566;
        var name = "Everlasting Legend\nSuper Saiyan Goku";
        var url = "https://dbz-dokkanbattle.fandom.com/wiki/Everlasting_Legend_Super_Saiyan_Goku#Before%20Z-Awakening";
        var desc = "Super TEQ LR";
        var circle = "https://media.discordapp.net/attachments/712036120191434793/726511358706974821/card_1007470_circle.png";
        var character = "https://media.discordapp.net/attachments/712036120191434793/726511552563249273/v3SemBBCa6oAAAAABJRU5ErkJggg.png";
        var leader = "All Types Ki +3, ATK +3000";
        var superatk = "Super Kamehameha (12-17 Ki): Causes colossal damage to enemy\n[Super Spirit Bomb](https://dbz-dokkanbattle.fandom.com/wiki/File:Everlasting_Legend_Super_Saiyan_Goku_Mega-Colossal_Super_ATK) (18+ Ki): Causes mega-colossal damage to enemy, allies' ATK +30% for 1 turn";
        var passive = "Crucial Battle: ATK +10000 & DEF +3000 when facing only 1 enemy";
        var stats = "HP: 17,800 (55%)/20,400 (100%)\nATK: 17,100 (55%)/20,500 (100%)\nDEF: 10,220 (55%)/13,220 (100%)";
        var links = "";
