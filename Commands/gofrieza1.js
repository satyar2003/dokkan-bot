module.exports = 
{
    ...
    execute(message, args) 
    {
        ...
        var leader = `"[Representatives of Universe 7](https://dbz-dokkanbattle.fandom.com/wiki/Representatives_of_Universe_7)" Category Ki +3 and HP, ATK & DEF +177%; or TEQ Type Ki +3 and HP, ATK & DEF +90%`;
