module.exports = {
    name: 'nandv2',
    description: 'AGL LR Vegeta after exchange',
    ...
    execute(message, args) {
        const {link} = require('./nandv2.js')
        const {categories} = require('./nandv2.js')
        const {status} = require('./nandv2.js')
        const {plural} = require('./nandv2.js')
        const {aliases} = require('./nandv2.js')
        var color = 2317729;
        var name = "Rampaging Vicious Saiyans\nVegeta";
        var url = "https://dbz-dokkanbattle.fandom.com/wiki/Rampaging_Vicious_Saiyans_Nappa/Vegeta#Vegeta";
        ...
        var blp = "[PHY UR Vegeta](https://dbz-dokkanbattle.fandom.com/wiki/Explosive_Super_Elite_Vegeta) - 5 links shared\n[AGL UR Vegeta (Giant Ape)](https://dbz-dokkanbattle.fandom.com/wiki/Power_for_the_Death-Match_Vegeta_(Giant_Ape)) - 4 links shared\n[PHY UR Nappa](https://dbz-dokkanbattle.fandom.com/wiki/Diabolical_Strike_Nappa) - 4 links shared";
