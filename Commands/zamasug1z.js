...
module.exports = {
    name: 'zamasug1z',
    description: 'STR LR Zamasu (Goku) with EZA',
    ...
    execute(message, args) {
        ...
        const {categories} = require('./zamasug1z.js')
        const {status} = require('./zamasug1z.js')
        const {plural} = require('./zamasug1z.js')
        const {aliases} = require('./zamasug1z.js')
        var color = 8990259;
        var name = "Dawn of Darkest Justice\nGoku (Zamasu) Z";
        var url = "https://dbz-dokkanbattle.fandom.com/wiki/Dawn_of_Darkest_Justice_Zamasu_(Goku)#Extreme%20Z-Awakened";
        ...
        var leader = "\"[Time Travelers](https://dbz-dokkanbattle.fandom.com/wiki/Time_Travelers)\" Category Ki +3 and HP, ATK & DEF +100%";
        var superatk = "[Black Power Ball](https://youtu.be/XNVBRWWxlPY?t=33) (12-17 Ki): Causes colossal damage to enemy and lowers ATK & DEF[1]\n[Fierce God Slicer](https://youtu.be/XNVBRWWxlPY?t=45) (18+ Ki): Raises ATK & DEF for 1 turn[2] and causes mega-colossal damage to enemy";
        var passive = "Zero Mortals Plan Begins: ATK & DEF +59%; Ki +1 with each attack received (up to +6); launches an additional attack that has a medium chance[3] of becoming a Super Attack when facing 2 or more enemies; plus an additional ATK & DEF +20% with each final blow delivered (up to 59%)";
        ...
        var apt = "APT: 2,871,557 (unsupported)/5,244,821 (supported)\nDefense: 112,061 (unsupported)/130,479 (supported) \nLinking Partner: [AGL UR Goku Black (Super Saiyan Rosé)](https://dbz-dokkanbattle.fandom.com/wiki/Rose_Stained_Super_Saiyan_Goku_Black_(Super_Saiyan_Ros%C3%A9)#Before%20Z-Awakening) \nTeam: [Realm of Gods](https://dbz-dokkanbattle.fandom.com/wiki/Realm_of_Gods)/[Extreme Class](https://dbz-dokkanbattle.fandom.com/wiki/Category:Extreme_Class) \nBuild: 6 Additional/20 Critical";
