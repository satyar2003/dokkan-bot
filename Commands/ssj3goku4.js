...
module.exports = {
    ...
    status: 'incomplete',
    plural: 'false',
    aliases: ['ss3goku4', 'Super Saiyan 3 Goku'],
    execute(message, args) {
		const pfp = message.author.displayAvatarURL({format: "png", dynamic: "true"})
        const {link} = require('./ssj3goku4.js')
        const {categories} = require('./ssj3goku4.js')
        const {status} = require('./ssj3goku4.js')
        const {plural} = require('./ssj3goku4.js')
        const {aliases} = require('./ssj3goku4.js')
        var color = 7028604;
        var name = "";
        var url = "";
        var desc = "";
