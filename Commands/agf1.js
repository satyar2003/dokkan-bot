...
module.exports = {
    ...
    execute(message, args) {
        ...
        var leader = "\"[Resurrected Warriors](https://dbz-dokkanbattle.fandom.com/wiki/Resurrected_Warriors)\" Category Ki +3, HP +130% and ATK & DEF +170%; or [INT](https://dbz-dokkanbattle.fandom.com/wiki/Category:INT) Type Ki +3 and HP, ATK & DEF +50%";
