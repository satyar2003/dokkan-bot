module.exports = {
    name: 'gb1',
    description: 'PHY UR Goku Black without EZA',
    ...
    execute(message, args) {
        ...
        var url = "https://dbz-dokkanbattle.fandom.com/wiki/Dark_Menace_Goku_Black#Global";
        ...
        var leader = "<:phy:729467520272039988> Type HP, ATK & DEF +100%";
        var superatk = "Black Kamehameha (SA Lv.1-9): Causes immense damage to enemy\n[Black Power Ball](https://dbz-dokkanbattle.fandom.com/wiki/File:(Super_Attack)_Goku_Black_-_Dark_Menace_(PHY)) (SA Lv.10+): Causes immense damage to enemy and lowers ATK & DEF[1]";
        var passive = "The Rush of Battle: Extreme Class Ki +3; ATK +3000 for every Ki Sphere obtained";
        var stats = "HP: 12,550 (55%)/15,950 (100%)\nATK: 11,800 (55%)/14,800 (100%)\nDEF: 6,525 (55%)/9,125 (100%)";
        const {link} = require('./gb1.js')
        var links = "";
            for (var i = 0; i < link.length; i++)
            {
                links += link[i] + "\n";
            }
        const {categories} = require('./gb1.js')
        var cats = "";
            for (var i = 0; i < categories.length; i++)
            {
                cats += categories[i] + "\n";
            }
        var apt = "APT: 1,346,470 (unsupported)/1,760,945 (supported)\nDefense: 40,150\nLinking Partner: [STR UR Goku Black (Super Saiyan Rosé)](https://dbz-dokkanbattle.fandom.com/wiki/Furious_Punishment_Goku_Black_(Super_Saiyan_Ros%C3%A9)) \nTeam: [Realm of Gods](https://dbz-dokkanbattle.fandom.com/wiki/Realm_of_Gods) \nBuild: 11 Additional/15 Critical";
