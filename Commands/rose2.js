module.exports = {
    ...
    execute(message, args) {
        ...
        var deets = "► 12 Ki Multiplier is 160%\n► Leader Skill info: if your team has one card of each Extreme Type ([Extreme AGL](https://dbz-dokkanbattle.fandom.com/wiki/Category:Extreme_AGL)/[Extreme TEQ](https://dbz-dokkanbattle.fandom.com/wiki/Category:Extreme_TEQ)/[Extreme INT](https://dbz-dokkanbattle.fandom.com/wiki/Category:Extreme_INT)/[Extreme STR](https://dbz-dokkanbattle.fandom.com/wiki/Category:Extreme_STR)/[Extreme PHY](https://dbz-dokkanbattle.fandom.com/wiki/Category:Extreme_PHY)) then you will receive the boost, meaning that the units need to be at least Z-Awakened\n► His Passive Skill and Super Attack boosts are for all Extreme Class allies, meaning that they don't need to be Z-Awakened to receive them";
        var footnotes = "";
