module.exports = {
    name: 'fkgohan1z',
    description: 'AGL UR Family Kamehameha Gohan with EZA',
    ...
    status: 'complete',
    plural: 'false',
    aliases: ['Super Saiyan Gohan (Teen) Z'],
    execute(message, args) {
        var color = 2317729;
        var name = "Unyielding Kamehameha\nSuper Saiyan Gohan (Teen) Z";
        var url = "https://dbz-dokkanbattle.fandom.com/wiki/Unyielding_Kamehameha_Super_Saiyan_Gohan_(Teen)#Extreme%20Z-Awakened";
        var desc = "Super AGL UR";
        var circle = "https://media.discordapp.net/attachments/712036120191434793/712854893165150248/card_1008930_circle.png";
        var character = "https://media.discordapp.net/attachments/712036120191434793/720534720961576971/gxDg2dFWB4AAAAAElFTkSuQmCC.png";
        var leader = "All Types Ki +2 and HP, ATK & DEF +50%";
        var superatk = "[Family Kamehameha](https://dbz-dokkanbattle.fandom.com/wiki/File:Unyielding_Kamehameha_Super_Saiyan_Gohan_(Teen)_Super_ATK): Raises ATK for 1 turn[1] and causes supreme damage to enemy";
        var passive = "Total Resolve: ATK +90% and DEF +40% when performing a Super Attack; disables Rampage[2]";
        var stats = "HP: 12,494 (55%)/15,094 (100%)\nATK: 13,183 (55%)/16,183 (100%)\nDEF: 7,523 (55%)/10,923 (100%)";
        const {link} = require('./fkgohan1z.js')
        var links = "";
            for (var i = 0; i < link.length; i++)
            {
                links += link[i] + "\n";
            }
        const {categories} = require('./fkgohan1z.js')
        var cats = "";
            for (var i = 0; i < categories.length; i++)
            {
                cats += categories[i] + "\n";
            }
        var apt = "APT: 2,372,653 (unsupported)/3,288,740 (supported)\nDefense: 67,285\nLinking Partner: [STR UR Super Saiyan Goku](https://dbz-dokkanbattle.fandom.com/wiki/Miraculous_Kamehameha_Super_Saiyan_Goku)\nTeam: [Goku's Family](https://dbz-dokkanbattle.fandom.com/wiki/Goku%27s_Family)\nBuild: 11 Additional/15 Critical";
        var blp = "[STR UR Super Saiyan Goten (Kid)](https://dbz-dokkanbattle.fandom.com/wiki/Furious_Kamehameha_Super_Saiyan_Goten_(Kid)) - 6 links shared\n[STR UR Super Saiyan Goku](https://dbz-dokkanbattle.fandom.com/wiki/Miraculous_Kamehameha_Super_Saiyan_Goku) - 6 links shared\n[AGL UR Super Saiyan Goku](https://dbz-dokkanbattle.fandom.com/wiki/Leaping_Ever_Higher_Super_Saiyan_Goku) - 6 links shared";
        ...
        const {status} = require('./fkgohan1z.js')
        if (stats === 'incomplete')
        {
        ...
        else
        {
            ...
            else if (args[0] === 'super')
            {
                message.channel.send({embed: {
                    ...
                    footer:
                    {
                        text: "[1]: Raises SA Multiplier by 30% for 1 turn"
                    }
                }});
            }
