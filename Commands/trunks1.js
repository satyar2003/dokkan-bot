module.exports = {
    name: 'trunks1',
    description: 'PHY UR Trunks (Teen)',
    ...
    execute(message, args) {
        var color = 7164715;
        var name = "Magnificent Swordship\nTrunks (Teen)";
        var url = "https://dbz-dokkanbattle.fandom.com/wiki/Magnificent_Swordsmanship_Trunks_(Teen)";
        ...
        const {link} = require('./trunks1.js')
        var links = "";
            for (var i = 0; i < link.length; i++)
            {
                links += link[i] + "\n";
            }
        const {categories} = require('./trunks1.js')
        var cats = "";
            for (var i = 0; i < categories.length; i++)
            {
                cats += categories[i] + "\n";
            }
        var apt = "APT: 4,362,446 (unsupported)/4,871,398 (supported)\nDefense: 65,558 \nLinking Partner: [STR LR Super Saiyan 4 Vegeta](https://dbz-dokkanbattle.fandom.com/wiki/Unrivaled_Saiyan%27s_Peak_Super_Saiyan_4_Vegeta) \nTeam: [Vegeta's Family](https://dbz-dokkanbattle.fandom.com/wiki/Vegeta%27s_Family) \nBuild: 20 Additional/6 Critical";
        var blp = "[TEQ UR Trunks (Teen) (Future)](https://dbz-dokkanbattle.fandom.com/wiki/Resilient_Will_to_Protect_the_Future_Trunks_(Teen)_(Future)) - 6 links shared\n[INT UR Paragus & Broly](https://dbz-dokkanbattle.fandom.com/wiki/Troublesome_Father_and_Son_Paragus_%26_Broly) - 5 links shared\n[INT UR Super Saiyan God SS Vegeta] - 4 links shared";
        var deets = "► 12 Ki Multiplier is 140%\n► His additional ATK +100% is calculated separately, for a total boost of ATK +300% when performing a Super Attack, while his DEF -50% nullifies his initial boost of +100%\n► [STR SR Trunks (Teen)](https://dbz-dokkanbattle.fandom.com/wiki/Future_Hope_Trunks_(Teen)) can be [farmed](https://dbz-dokkanbattle.fandom.com/wiki/Leveling_Super_Attack_Guide) to raise Super Attack";
        var footnotes = "[1]: Raises SA Multiplier by 100% for 1 turn";
        const {status} = require('./trunks1.js')
        if (status === 'incomplete')
        {
            message.channel.send({embed: {
                ...
                title: "Trunks (Teen) is coming soon."
            }});
        }
        else
        {
