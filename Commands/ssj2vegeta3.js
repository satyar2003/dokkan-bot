...
module.exports = {
    ...
    execute(message, args) {
        ...
        var leader = "\"[Worthy Rivals](https://dbz-dokkanbattle.fandom.com/wiki/Worthy_Rivals)\" Category Ki +4 and HP, ATK & DEF +150%; or [Super PHY](https://dbz-dokkanbattle.fandom.com/wiki/Category:Super_PHY) Type Ki +4 and HP, ATK & DEF +100%";
