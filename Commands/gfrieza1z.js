module.exports = {
    name: 'gfrieza1z',
    description: 'TEQ UR Golden Frieza with EZA',
    ...
    link: ['[Universe\'s Most Malevolent](https://dbz-dokkanbattle.fandom.com/wiki/Universe%27s_Most_Malevolent) (ATK +15%)',
    ...
    execute(message, args) {
        ...
        var url = "https://dbz-dokkanbattle.fandom.com/wiki/Fire_of_Vengeance_Golden_Frieza#Extreme%20Z-Awakened";
        ...
        var leader = "<:teq:729467504593862728> Type Ki +3 and HP, ATK & DEF +120%";
        var superatk = "[Earth Breaker](https://dbz-dokkanbattle.fandom.com/wiki/File:Perfect_Supremacy_Golden_Frieza_Super_ATK): Causes immense damage to enemy and massively lowers DEF[1]";
        var passive = "Moment of Counterattack: ATK +80%; reduces damage received by 80% when HP is 50% or more; reduces damage received by 50% plus an additional ATK +50% when HP is 49% or less";
        var stats = "HP: 14,341 (55%)/16,941 (100%)\nATK: 13,853 (55%)/17,253 (100%)\nDEF: 7,907 (55%)/10,907 (100%)";
        const {link} = require('./gfrieza1z.js')
        var links = "";
            for (var i = 0; i < link.length; i++)
            {
                links += link[i] + "\n";
            }
        const {categories} = require('./gfrieza1z.js')
        var cats = "";
            for (var i = 0; i < categories.length; i++)
            {
                cats += categories[i] + "\n";
            }
        var apt = "APT: 2,673,239 (unsupported)/3,267,293 (supported)\nDefense: 47,990\nLinking Partner: [INT UR Golden Frieza (Angel)](https://dbz-dokkanbattle.fandom.com/wiki/Emperor%27s_True_Splendor_Golden_Frieza_(Angel)) \nTeam: [Resurrected Warriors](https://dbz-dokkanbattle.fandom.com/wiki/Resurrected_Warriors) \nBuild: 6 Additional/20 Critical";
        ...
        const {status} = require('./gfrieza1z.js')
