...
module.exports = {
    ...
    execute(message, args) {
        ...
        var leader = `"[Androids](https://dbz-dokkanbattle.fandom.com/wiki/Androids)" Category Ki +4 and HP, ATK, & DEF +150%; or [Extreme PHY](https://dbz-dokkanbattle.fandom.com/wiki/Category:Extreme_PHY) Type Ki +4 and HP, ATK, & DEF +100%`;
