module.exports = {
    name: 'ssj3vegeta2',
    description: 'STR UR Super Saiyan 3 Vegeta without EZA',
    ...
    status: 'complete',
    plural: 'false',
    aliases: ['ss3vegeta2', 'Super Saiyan 3 Vegeta'],
    execute(message, args) {
        const {link} = require('./ssj3vegeta2.js')
        const {categories} = require('./ssj3vegeta2.js')
        const {status} = require('./ssj3vegeta2.js')
        const {plural} = require('./ssj3vegeta2.js')
        const {aliases} = require('./ssj3vegeta2.js')
        var color = 8990259;
        var name = "Warrior's True Value\nSuper Saiyan 3 Vegeta";
        var url = "https://dbz-dokkanbattle.fandom.com/wiki/Warrior%27s_True_Value_Super_Saiyan_3_Vegeta#Before%20Z-Awakening";
        ...
        var leader = "<:str:729468929293942894> Type ATK +80%";
        var superatk = "Galick Blazer: Supreme damage, high chance to stun the enemy[1]";
        var passive = "Aura of the Supreme: Reduce received damage by 80% for 7 turns from start of turn";
