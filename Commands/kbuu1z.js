module.exports = {
    name: 'kbuu1z',
    description: 'PHY UR Buu (Kid) with EZA',
    ...
    link: ['[Majin](https://dbz-dokkanbattle.fandom.com/wiki/Majin) (ATK & DEF +10%)',
           ...
           '[More Than Meets the Eye](https://dbz-dokkanbattle.fandom.com/wiki/More_Than_Meets_the_Eye) (ATK +300)',
    ...
    execute(message, args) {
        const {link} = require('./kbuu1z.js')
        const {categories} = require('./kbuu1z.js')
        const {status} = require('./kbuu1z.js')
        const {plural} = require('./kbuu1z.js')
        const {aliases} = require('./kbuu1z.js')
        var color = 7164715;
        var name = "Heartless Destruction\nBuu (Kid) Z";
        var url = "https://dbz-dokkanbattle.fandom.com/wiki/Heartless_Destruction_Buu_(Kid)#Extreme%20Z-Awakened";
        ...
        var leader = "All Types Ki +3 and HP & DEF +50%, raises ATK by up to 80% (the more HP remaining, the greater the ATK boost)";
        var superatk = "Planet Burst: Causes immense damage to enemy and lowers DEF[1]";
        var passive = "Planetary Destruction: All allies' Ki +2 and ATK & DEF +50% when HP is 80% or above; all allies' ATK & DEF +30% when HP is 79% or below";
        var stats = "HP: 16,715 (55%)/21,475 (100%)\nATK: 11,864 (55%)/16,064 (100%)\nDEF: 6,563 (55%)/10,203 (100%)";
        var links = "";
